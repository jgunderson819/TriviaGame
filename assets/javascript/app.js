    ...
    pages: [
        {
            questions: [
                {
                    type: "html",
                    html: "You are about to start the quiz with all state capitals. <br/>You have 10 seconds for every page and 7 minutes for the whole survey of 50 questions.<br/>Please click on <b>'Start Quiz'</b> button when you are ready."
                }
            ]
        }, {
            questions: [
